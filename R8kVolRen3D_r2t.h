...
//-------------------------------------------------------------------------
// R8kVolRen3D_r2t.h: interface for the R8kVolRen3D_r2t class.
//
//////////////////////////////////////////////////////////////////////

#ifndef R8kVolRen3D_r2t2_DOT_H
#define R8kVolRen3D_r2t2_DOT_H
...
class R8kVolRen3D_r2t : public gluvvPrimitive  
{
public:
	R8kVolRen3D_r2t();
	virtual ~R8kVolRen3D_r2t();
...
private:
  ...
  void createNoiseTex(int sx, int sy, int sz);   //creates the noise texture
  void createCubeTex();    //creates the cube map for shading
	...
	void createFragShadow(unsigned int *&names); // create and update fragment shaders
	void createFragNoise(unsigned int *&names); // create and update fragment shaders
  ...
  unsigned int noiseName;    //perturbation noise texture
  ...
  unsigned int *pbfnNames;   //fragment shader names (noise)
  unsigned int cpfsName;     //clipping plane fragement shader.
	...
	PBuffer *pbuff2;           //pbuffer for rendering data cache & perturbation
...
#endif // !defined(AFX_R8kVolRen3D_r2t_H__F0928F0F_2C8C_47F5_95AD_59CBF70749C9__INCLUDED_)
